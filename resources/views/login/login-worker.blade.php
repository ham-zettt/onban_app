...
@section("content")
    ...
    <form class="max-w-md mx-auto">
        ...
        <button type="submit" class="text-secondary text-md bg-white hover:bg-primary focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
        <div class="inline-flex items-center justify-center w-full">
            <hr class="w-64 h-px my-5 bg-gray-200 border-0 dark:bg-gray-700">
            <span class="absolute text-[12px] px-3 font-medium text-white -translate-x-1/2 bg-secondary left-1/2 dark:text-white dark:bg-gray-900">Belum Punya Akun?</span>
        </div>
        <a href="{{ route('register-worker') }}" class=" text-secondary text-md bg-white hover:bg-primary focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</a>
    </form>
@endsection