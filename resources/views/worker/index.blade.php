            ...
            <li class="py-3">
                <div class="flex items-center">
                    ...
                    <div class="items-center text-base font-semibold text-gray-900 text-center">
                        ...
                        @endif
                        <div class="pt-1">
                            <button data-modal-target="default-modal-{{ $order->id_order }}" data-modal-toggle="default-modal-{{ $order->id_order }}" class="text-xs bg-primary text-white hover:bg-primary-dark rounded-lg p-2">Lihat Detail</button>
                        </div>
                    </div>
                </div>
            </li>
            <!-- Main modal -->
            <div id="default-modal-{{ $order->id_order }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative p-4 w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                            ...
                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center " data-modal-hide="default-modal-{{ $order->id_order }}">
                        ...
                        <div class="p-6 text-gray-800">
                            <h5 class="text-xl font-bold text-gray-800">Tambal {{ $order->tipe_layanan->nama_tipe_layanan }}</h5>
                            <iframe class="border border-primary my-4 pt-3" height="300" src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d7917.826116690897!2d{{ $order->longitude }}!3d{{ $order->latitude }}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sid!2sid!4v1716094381407!5m2!1sid!2sid" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            <div class="px-3">
                                <table class="table w-full">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">{{ $order->metode_pembayaran->nama_metode_pembayaran }}</td>
                                        </tr>
                                        <tr>
